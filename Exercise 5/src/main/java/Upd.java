    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (bn != null && a != null && p != null && e != null && pri != null && c != null) {
             ...
             // Prepare SQL query
                String sql = "UPDATE lib SET author = ?, publisher = ?, edition = ?, price = ?, category = ? WHERE book_name = ?";
                ...
                ps.setString(4, pri);
                ps.setString(5, c);
                ps.setString(6, bn); // Use book_name for the WHERE clause

                // Execute SQL query
                int res = ps.executeUpdate();

                if (res != 0) {
                    out.println("<p>Book Details updated successfully...</p>");
                } else {
